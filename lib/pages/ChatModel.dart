...
class ChatModel {
  ...
  try {
    ...
    String lastMessagePreview = messageContent.length > 30 ? messageContent.substring(0, 30) : messageContent;
    ...
    await firestore
      ...
      .update({
        ...
        'lastMessageAt': Timestamp.now(), // Optionally update a timestamp for sorting or display
      });
  } catch (e) {
